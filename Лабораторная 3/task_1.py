...
class PaperBook(Book):
    ...
    def __str__(self):  # можно наследовать, но я добавил дополнительно вывод атрибута pages
...
class AudioBook(Book):
    ...
    def __str__(self):  # можно наследовать, но я добавил дополнительно вывод атрибута duration
